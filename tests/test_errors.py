...
def test_a_dict_body_in_no_known_envelope_still_degrades_to_apierror():
...
def test_an_unparseable_retry_after_falls_back_to_the_default():
...
def test_a_422_without_recordinvalid_or_problems_is_an_apierror_not_a_validationerror():
...
def test_retry_after_is_found_whatever_the_header_casing():
