...
| **Block 0b: authentication** | Public OAuth client with PKCE and exactly one token file ([ADR-009](DECISIONS-ADR/ADR-009.md)). Nothing is callable against a real Zendesk until this lands |
